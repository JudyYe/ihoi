...
_C.MODEL_SIG = ''
_C.MODEL_PATH = ''
_C.OUTPUT_DIR = '/private/home/yufeiy2/scratch/result/ihoi/'
...
_C.DB.DIR = '/private/home/yufeiy2/scratch/data/ihoi'  # change to your path
_C.DB.RADIUS = 0.2
_C.DB.CACHE = True
_C.DB.IMAGE = False
...
_C.HAND = CN()
_C.HAND.WRAP = 'mano'
_C.HAND.MANO_PATH = '/private/home/yufeiy2/scratch/pretrain/smpl/mano_v1_2/models' # '../data/smplx/mano'
